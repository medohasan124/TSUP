          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="about-left-image  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{asset('frontEnd')}}/assets/images/about-dec.png" alt="">
              </div>
            </div>
                ...
                <div class="col-lg-12">
                  <div class="menu">
                    <div class="first-thumb active">
                      <div class="thumb">
                        <span class="icon"><img src="{{asset('frontEnd')}}/assets/images/service-icon-01.png" alt=""></span>
                        Apartments
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="{{asset('frontEnd')}}/assets/images/service-icon-02.png" alt=""></span>
                        Food &amp; Life
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="{{asset('frontEnd')}}/assets/images/service-icon-03.png" alt=""></span>
                        Cars
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="{{asset('frontEnd')}}/assets/images/service-icon-04.png" alt=""></span>
                        Shopping
                      </div>
                    </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="{{asset('frontEnd')}}/assets/images/services-image.jpg" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="{{asset('frontEnd')}}/assets/images/services-image-02.jpg" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="{{asset('frontEnd')}}/assets/images/services-image-03.jpg" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="{{asset('frontEnd')}}/assets/images/services-image-04.jpg" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
